...
**Итого:** 30 vCPU, 46 GB RAM, 382 GB SSD
...
**DNS-сервер:** На DNS-сервере 100.100.100.100 настроена зона `ssa2026.region`
...
| --- | --- | --- |
| 0 | [Настройка виртуальной машины ISP](modules/00-isp-config.md) | ✅ |
...
| 8 | [Настройка доступа к веб-интерфейсу fw-cod и лицензирование](modules/08-fwcod-web-config.md) | ✅ |
| 9 | [Создание интерфейсов типа VLAN на fw-cod](modules/09-fwcod-vlan-config.md) | ✅ |
| 10 | [Настройка коммутации между sw1-cod и sw2-cod](modules/10-switching-cod-config.md) | ✅ |
| 11 | [Настройка имён и IP-адресов на всех остальных устройствах](modules/11-hosts-ip-config.md) | ✅ |
| 12 | [Настройка административного доступа (RADIUS)](modules/12-radius-config.md) | ✅ |
| 13 | [Настройка синхронизации времени (NTP)](modules/13-ntp-config.md) | ✅ |
| 14 | [Настройка службы доменных имен в COD](modules/14-dns-cod-config.md) | ✅ |
| 15 | [Развёртывание контроллера домена Samba AD](modules/15-samba-ad-config.md) | ✅ |
| 16 | [Настройка службы доменных имен в OFFICE](modules/16-dns-office-config.md) | ✅ |
| 17 | [Настройка центра сертификации (CA)](modules/17-ca-config.md) | ✅ |
| 18 | [Настройка сервера баз данных (PostgreSQL)](modules/18-postgresql-config.md) | ✅ |
| 19 | [Настройка устройства хранения данных (iSCSI)](modules/19-iscsi-config.md) | ✅ |
| 20 | [Настройка устройства хранения данных (LVM)](modules/20-lvm-config.md) | ✅ |
| 21 | [Настройка устройства хранения данных (NFS)](modules/21-nfs-config.md) | ✅ |
| 22 | [Настройка системы мониторинга (Zabbix)](modules/22-zabbix-config.md) | ✅ |
| 23 | [Настройка IP-телефонии (FreePBX)](modules/23-freepbx-config.md) | ✅ |
| 24 | ... | 🔜 |
